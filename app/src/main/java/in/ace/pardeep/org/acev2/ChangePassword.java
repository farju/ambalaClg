...
public class ChangePassword extends Fragment {
    ...
    private void sendDataToServer(String oldpassword, String newpassword, String confirmpassword) {
        ...
        jobCancel=false;
        sharedPreference=getActivity().getSharedPreferences(StudentPortal.getSharedPrefProfile(),0);
        String rollno=sharedPreference.getString("rollno",null);
        String url="http://aceapp-pardeep16.rhcloud.com/student/api/changepassword?rollno="+rollno;
